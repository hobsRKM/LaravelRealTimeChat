...
//      scrollHeight -= parseInt(this.css('padding-top')) + parseInt(this.css('padding-bottom'));
    ...
    /**
     * 
     * for detect typing and enter key press
     */

    var $body = $(document.body);
    $body.on('keyup', function (e) {
//       alert($("#messageBox").next().html().length) 
 if ($("#messageBox").next().text().length != 0 || $("#messageBox").next().html().length>=288) {
    if (event.keyCode == 13 && event.shiftKey) {
        ...
        var room=$('#send').attr("room");
        var details = $("#messageBox").attr("data-channel-id");
         var toUserId = userId+"_"+details;
       switch(code){
           case 13: 
                    if(room=="user"){
                        ...
                        detectTyping(false, toUserId);
                        sendMessage(cid,false);
                    }
           break;
           default:detectTyping(true, toUserId);
