    ...
    <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr style="background-color:#2196f3">
                  <td width="64"><img style='     margin-left: 7px;
                                                             margin-top: 6px;   border-radius: 25px;' height="50px" width="50px" src="http://localhost/fmlogont.png"/></td>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="10%">&nbsp;</td>
                <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi ,</em></strong></font><br /><br />
                  <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; "> 

You are invited to join a team in fusionmate..<br/>
To collaborate  with your team mates click the link below and follow onscreen instructions.<br/>
<center><a style=' 
                                                           ...
                                                           display: inline-block;' href="{{$url}}">JOIN</a></center>
<br /><br />
